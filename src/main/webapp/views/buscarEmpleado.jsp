...
<body>
	...
	<form action="empresa" method="post">
		<input type="text" name="criterio"
			placeholder="Buscar por DNI, Nombre o Categoría" required /> <input
			type="hidden" name="opcion" value="ebuscar" /> <input type="submit"
			value="Buscar" />
	</form>
				...
				<tr>
					...
					<td>
						<form action="EmpresaController" method="post">
							<input type="hidden" name="opcion" value="buscar"> <label
