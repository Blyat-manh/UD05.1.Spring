...
<body>
    ...
    <tr>
        ...
        <td>
            <form action="/empleado/editar" method="get">
                <input type="hidden" name="dni" value="${e.dni}">
                <input type="submit" value="Editar">
            </form>
            <form action="/empleado/eliminar" method="post" onsubmit="return confirm('¿Estás seguro de que deseas eliminar este empleado?');">
                <input type="hidden" name="dni" value="${e.dni}">
